        ...
        <div className="relative mx-10vw">
            ...
            <div className="col-span-full pt-6 lg:col-start-1 lg:row-start-1 lg:flex lg:h-full lg:flex-col lg:col-span-5">
                ...
                <h2 className="leading-tight text-3xl md:text-4xl text-black dark:text-white">
                    ¡Hola!<h2 className="text-stone-300 text-xl">My name is Camila.</h2></h2>
                    <h3>I build things.</h3>
                    <p>I’m a software engineer specializing in building digital experiences. Currently, I’m focused on building accessible and human-centered products at <a className="text-blue-800  hover:underline decoration-2" href="https://bluumhub.com" target="_blank">BluumHub</a>.</p>
