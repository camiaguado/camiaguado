        ...
        <div className="relative mx-10vw">
            ...
            <div className="col-span-full pt-6 lg:col-start-1 lg:row-start-1 lg:flex lg:h-full lg:flex-col lg:col-span-5">
                <h2 className="leading-tight text-3xl md:text-4xl text-black dark:text-white">
                    ¡Hola! <h2 className="text-stone-300">en esta web vas a encontrar articulos, recomendaciones, un poco de mi experiencia y algunos proyectos para que puedas entender e incursionar en la tecnología desde lo básico.</h2></h2>
            ...
            <div className="col-span-full mb-12 lg:mb-0 flex items-center justify-center lg:col-span-7 lg:col-start-6 lg:-mt-24 lg:-mr-5vw lg:px-0">
                <img className="py-20 relative" src="https://w7.pngwing.com/pngs/65/162/png-transparent-drawing-cartoon-girl-child-sketch-girl-cartoon-mammal-hand-fashion.png"/>
            </div>
